...
class SolarCalculator {
	public:
		...
		static double zenithPrecalculation(double currentLatitude, AstronomicalCoordinate a);
		static double zenith(double zenithPrecalculation);
		static double azimuth(double zenithPrecalculation, GeographicalCoordinate g, AstronomicalCoordinate a, DateTime t);
